...
FEW_SHOT_EXAMPLES = [
    ...
    },
    {
        ...
        "expected_output": [
            ...
            },
            {
                ...
                "reasoning": "Omitting water as per user's recipe variation",
                "edits": [
                    {
                        "target": "ingredients",
                        "operation": "remove",
    ...
    },
    {
        ...
        "expected_output": [
            {
                "modification_type": "quantity_adjustment",
                "reasoning": "Improves flavor balance",
                "edits": [
                    {
                        "target": "ingredients",
                        "operation": "replace",
            ...
            {
                "modification_type": "removal",
                "reasoning": "Omitting nuts per user preference",
                "edits": [
                    {
                        "target": "ingredients",
                        "operation": "remove",
...
You MUST identify ALL distinct modifications mentioned in the review. Each distinct modification must be a separate ModificationObject.

Output an array of JSON objects (List[ModificationObject]) with the following structure. Always return an array, even if there is only one modification:
[
    {{
    ...
    "edits": [
        {{
            "target": "must be 'ingredients' or 'instructions'",
    ...
    // Add additional ModificationObjects here if multiple distinct changes are found.
]
